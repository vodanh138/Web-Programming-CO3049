...
<body>
  ...
  <form id="register_form" action="register_processing.php" method="post">
    ...
    <div id="error-special" class="error-special" style=color:green><span>&#10004;</span>*Your password must contain only letters and numbers</div>
